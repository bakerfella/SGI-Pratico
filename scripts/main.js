...
const acrylicColor = TextureLoader.load(
    "models\assets\materials\acrylic_564227e0-b76e-4f32-97c1-0bfcf024c71d"
);

const IronBaseColor = TextureLoader.load(
    "models\assets\materials\worn-aluminum-bl\worn-aluminum_albedo.png"
);

const IronAO = TextureLoader.load(
    "models\assets\materials\worn-aluminum-bl\worn-aluminum_ao.png"
);

const IronNormal = TextureLoader.load(
    "models\assets\materials\worn-aluminum-bl\worn-aluminum_normal-ogl.png"
);

const IronHeight = TextureLoader.load(
    "models\assets\materials\worn-aluminum-bl\worn-aluminum_height.png"
);

const IronRoughness = TextureLoader.load(
    "models\assets\materials\worn-aluminum-bl\worn-aluminum_roughness.png"
);

const IronMetallic = TextureLoader.load(
    "models\assets\materials\worn-aluminum-bl\worn-aluminum_metallic.png"
);
